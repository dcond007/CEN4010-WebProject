    ...
    <div className="author-info">
     <ul>
      ...
      <div class="formBox">
          ...
          <div class="formBox">
            <input type="checkbox" id="nick" placeholder="Name" />
            <label> Check to use NickName</label>
          </div>
...
function addComment () {
  ...
  var radio8 = document.getElementById("nick");
  ...
  if(radio8.checked)
  {
      usrField.Name = document.getElementById("nickname").value;
  }
  // add in an array
  ...
  pre.textContent += "\nReview ID: " + JSON.stringify(usrComments[i].Date, "\t", 2)
  + "\nUser Name: " + JSON.stringify(usrComments[i].Name, "\t", 2)
  + "\nRating: " + JSON.stringify(usrComments[i].Rating, "\t", 2)
  + "\nComment: " + JSON.stringify(usrComments[i].Comment, "\t", 2)
  + "\n\n\n";
  i++;
  ...
  let pre = document.querySelector("#msg pre");
  pre.textContent = "Im Sorry, The book must be purchased to Leave a Review.";
